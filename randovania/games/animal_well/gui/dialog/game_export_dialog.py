...
from randovania.games.animal_well.exporter.game_exporter import AnWellGameExportParams
...
class AnWellGameExportDialog(GameExportDialog):
    ...
    def update_per_game_options(self, per_game: PerGameOptions) -> AnWellPerGameOptions:
        assert isinstance(per_game, AnWellPerGameOptions)
    ...
    def get_game_export_params(self) -> AnWellGameExportParams:
